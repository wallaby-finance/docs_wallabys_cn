...
- 预售
  ...
  - 返回：100,000个HT的LP代币+锁定的500,000个Token代币

  - 每1 HT会赠送10个Token代币。如果所有100,000 HT都被售出并分配，则总共将发行1,000,000 Token。
...
- 预期用途
  ...
  - 流动资金池
    ...
    - 一旦创建了池子，将在Mdex流动性池（估计价值：1,500,000美元）中放入50,000 HT和500,000 Token。
  ...
  - 奖励池
    ...
    - 建立奖池后，预售参与者的500,000 Token会被抵押。

    - 50,000 HT将累积为奖励，并将在365天内分配。

    - 预售参与者将获得Token锁定。发行后，预售的Token代币将根据发行的新Token代币的数量平均解锁。

    - 连续1年的筹码可全额提取50,000 HT且不收取任何费用。
